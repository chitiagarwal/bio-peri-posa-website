...
export class Backend implements backendInterface {
    ...
    async getAllCareerInterests(): Promise<Array<CareerInterest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCareerInterests();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async submitCareerInterest(arg0: CareerInterest): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitCareerInterest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
